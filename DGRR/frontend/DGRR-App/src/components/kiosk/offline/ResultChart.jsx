...
import '../../../scss/OfflineResultChart.scss'
...
const ResultChart = ({ data, yKey, xKey }) => {
  ...
  return (
    <ResponsiveContainer width={'100%'} height={50 * data.length} debounce={50}>
      <BarChart data={data} layout="vertical" margin={{ left: 10, right: maxTextWidth + (BAR_AXIS_SPACE - 8) }}>
