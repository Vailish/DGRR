    ...
    <div className="RecordBox">
      <div className="BaseRecordBox">
        <div className="LeftInfo">
          {/* <span>2023. 01. 18(수) {gameInfo.gameType ? '랭킹전' : '친선전'}</span> */}
          <span>2023. 01. 18(수) {'랭킹전'}</span>
          <div className="MyScoreBoard">
            ...
            <div>
              {/* <ScoreTable isInput={false} scoreArray={gameInfo.socre} scoreSumArray={gameInfo.sumScore} /> */}
