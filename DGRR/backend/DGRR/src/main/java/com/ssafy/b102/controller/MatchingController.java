...
public class MatchingController {
	...
	@PostMapping("/gaming/{nickname}")
	public ResponseEntity<?> gaming(@PathVariable String nickname, @RequestBody GamingRequestDto gamingRequestDto) {
		GamingResponseDto gaming = matchingService.gaming(nickname, gamingRequestDto);
		return new ResponseEntity<GamingResponseDto>(gaming, HttpStatus.OK);
	}
}